...
@Table(
        ...
        uniqueConstraints = {
            @UniqueConstraint(
                name = "uk_atlas_rewards_atlas_level",
                columnNames = {"atlas_id", "target_level"}
        )},
        indexes = {
                @Index(name = "idx_atlas_rewards_atlas", columnList = "atlas_id"),
                @Index(name = "idx_atlas_rewards_target_level", columnList = "target_level")
        }
)
@Getter
