...
@Table(
    ...
    uniqueConstraints = @UniqueConstraint(name = "uk_user_challenge_user_challenge", columnNames = {"user_id", "challenge_id"}),
    indexes = {
...
public class UserChallenge {
    ...
    private ChallengeStatus status = ChallengeStatus.NOT_STARTED; // 유저의 과제 진행 상태 / NOT_STARTED, IN_PROGRESS, WAIT_REWARD, COMPLETED
